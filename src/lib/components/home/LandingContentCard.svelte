...
<ContentCard
  class={cn(
    ...
    card.variant === "testimonial" ? "w-[min(20rem,calc(100vw-3.5rem))] flex-none" : "pb-14",
    className,
  )}
>
  {#if card.variant === "project"}
    <div class="h-52 overflow-hidden rounded-md sm:h-96">
      <img
        src={card.image}
  ...
  {:else}
    <div class="flex items-center gap-2">
      ...
      <CardHeading
        ...
        titleTag="p"
        descriptionSpacingClass="mt-2"
        descriptionClass="text-xs leading-none"
      />
    </div>
