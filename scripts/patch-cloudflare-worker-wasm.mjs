...
const resvgWasmImportLine = 'import __blogOgResvgWasmModule from "./resvg-index_bg.wasm";';
const resvgWasmGlobalLine = "globalThis.__blogOgResvgWasmModule = __blogOgResvgWasmModule;";
const yogaWasmFileName = "satori-yoga.wasm";
const yogaWasmImportLine = `import __blogOgYogaWasmModule from "./${yogaWasmFileName}";`;
const yogaWasmGlobalLine = "globalThis.__blogOgYogaWasmModule = __blogOgYogaWasmModule;";
...
const injectedLines = [anchor, resvgWasmImportLine, resvgWasmGlobalLine, yogaWasmImportLine, yogaWasmGlobalLine].join(
  "\n",
);
